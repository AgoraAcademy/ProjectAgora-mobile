    ...
    componentDidMount() {
        Taro.checkSession({
            success: async () => {
                ...
                const learnerFullName = await Taro.getStorageSync(
                    "learnerFullName"
                );
        ...
        return (
            <View>
                ...
                <View className="index-wrap">
                    ...
                    <AtButton
                        customStyle={{
                            display: Taro.getStorageSync("isAdmin")
                                ? "block"
                                : "none"
                        }}
                        onClick={() =>
                    ...
                    <View
                        className="bottom-bar at-row at-row__justify--center"
                        style={{
                            position: "absolute",
                            bottom: "16px",
                            left: "50%"
